...
from launcher.sand_stream import (
    ...
    MANAGED_SUBAGENT_SESSION_319_ORIGINAL,
...
RELATED_NEEDLES: dict[str, tuple[str, ...]] = {
    ...
    "subagentRoute": ("hasUnsupportedRunOptions", "isHostedSubagentChild:Boolean"),
    ...
    "subagentSession": (
        "enableEmptyResponseRetry:!0",
        "nalLoopDetection:!0",
        "outputNotificationLimit:1e3",
...
RULES: tuple[RuleSpec, ...] = (
    ...
    RuleSpec(
        ...
        "L6",
        (SAND_MANAGED_TASK_TOOL_MARKER,),
        lambda c: MANAGED_TASK_TOOL_ORIGINAL in c or MANAGED_TASK_TOOL_319_ORIGINAL in c,
        required="l6",
    ),
    RuleSpec(
        "subagentRoute",
        ...
        or MANAGED_SUBAGENT_ROUTE_319_ORIGINAL in c,
        required="l6",
    ),
    RuleSpec(
        "actionRoute",
        ...
        "L6",
        (SAND_MANAGED_ACTION_ROUTE_MARKER,),
        lambda c: MANAGED_ACTION_ROUTE_ORIGINAL in c or MANAGED_ACTION_ROUTE_319_ORIGINAL in c,
        required="l6",
    ),
    RuleSpec(
        "resumeMode",
    ...
    RuleSpec(
        ...
        _unmarked(
            ...
            or MANAGED_SUBAGENT_SESSION_319_ORIGINAL in c,
        ),
        required="l6",
    ),
    RuleSpec(
